...
//  Fashion-Now
//
//  Created by Igor Camilo on 2015-05-05.
...
// from https://github.com/globchastyy/SwiftUIImageEffects on 2015-05-05
...
extension UIImage {
    ...
    convenience init?(fn_color color: UIColor) {
    ...
    func fn_dataFit(size newSize: CGSize = CGSize(width: 1024, height: 1024), quality: CGFloat = 0.5) -> NSData {
        return UIImageJPEGRepresentation(scaleToFitSize(newSize), quality)
    }

    /// :returns: Compressed JPEG Data to fill square of this size and opaque
    func fn_dataFill(size newSize: CGSize = CGSize(width: 256, height: 256), quality: CGFloat = 0.5) -> NSData {
        return UIImageJPEGRepresentation(scaleToCoverSize(newSize), quality)
    }
//
//    func fn_resize(scale resizeScale: CGFloat) -> UIImage {
//        var img: UIImage?
//        if resizeScale < 1 {
//            return fn_resize(size: CGSize(width: size.width * resizeScale, height: size.height * resizeScale))
//        }
//        return self
//    }
//
//    func fn_resize(size newSize: CGSize) -> UIImage {
